 ...
 * Represents a single account record from the indexed VSAM KSDS input file.
 */
public record AccountRecord(
        ...
        String openDate,               // PIC X(10) e.g. "2014-11-20"
        String expirationDate,         // PIC X(10) e.g. "2025-05-20"
        String reissueDate,            // PIC X(10) e.g. "2025-05-20"
    ...
    /**
     * Parses a fixed-length 300-character account record line (ASCII representation).
