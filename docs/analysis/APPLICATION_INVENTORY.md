...
| `CBIMPORT.jcl` | STEP01 `CBIMPORT` | EXPFILE=`…EXPORT.DATA` → CUSTOUT=`…CUSTDATA.IMPORT`, ACCTOUT=`…ACCTDATA.IMPORT`, XREFOUT=`…CARDXREF.IMPORT`, TRNXOUT=`…TRANSACT.IMPORT`, ERROUT=`…IMPORT.ERRORS` |
