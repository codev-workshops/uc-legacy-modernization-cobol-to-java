...
public class DisclosureGroupId implements Serializable {
    ...
    public void setDisAcctGroupId(String v) { this.disAcctGroupId = v; }

    public String getDisTranTypeCd() { return disTranTypeCd; }
    public void setDisTranTypeCd(String v) { this.disTranTypeCd = v; }

    public Integer getDisTranCatCd() { return disTranCatCd; }
    public void setDisTranCatCd(Integer v) { this.disTranCatCd = v; }
